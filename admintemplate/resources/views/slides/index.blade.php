                    ...
                    <div class="col-lg-1" style="padding-top: 10px;">
                        <!-- Image loader -->
                            ...
                            <div id='loader' style='display: none;'>
                                <img src="{{asset('admin_assets/img/gif/ajaxload.gif')}}" width='32px' height='32px'>
                            </div>
                        <!-- Image loader -->
                    </div>
