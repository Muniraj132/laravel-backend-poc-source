...
<script>
      ...
      rules: {
        ...
        submitHandler: function (form) {
           ...
           $.ajax({
                ...
                contentType: false, 
                processData: false,
                url: "<?php echo e(route('userregister.save')); ?>",
 ...
 var table = $('#newseventstable').DataTable({
      processing: true,
      serverSide: true,
      ajax: "<?php echo e(route('usersget')); ?>",
      columns: [
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Loreto Sisters\admintemplate\resources\views/users/users.blade.php ENDPATH**/ ?>