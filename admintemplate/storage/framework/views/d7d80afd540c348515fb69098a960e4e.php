                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            ...
                            <strong><?php echo e($contentCount); ?></strong>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
 ...
 var table = $('#newseventstable').DataTable({
      processing: true,
      serverSide: true,
      ajax: "<?php echo e(route('events.get')); ?>",
      columns: [
    ...
    function newsview(id,data){
        ...
        var data = {'id' : id};
        $.ajax({
        url : "<?php echo e(Route('events.show')); ?>",
        method : "GET",
        data : data,
            success: function(response) {
                var imageUrl = "<?php echo e(asset('upcomingEvents/')); ?>";
    ...
    $("#closeModalDel").click(function() {
      ...
      e.preventDefault();
        ...
        $.ajax({
        method : "get",
        url: "<?php echo e(route('events.destroy')); ?>",
        data : data,
          success: function(response) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Loreto Sisters\admintemplate\resources\views/dashboard.blade.php ENDPATH**/ ?>